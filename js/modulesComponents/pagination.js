...
const getEventsId = async(e)=>{
    ...
    await nameEvent(Events)
    await DetailsEventInformation(Events)
    await EventDate(Events)
...
export const PaginationCores = async(page = 1, limit = 5)=>{
    ...
    div.appendChild(end);
    console.log(div);
    let [back, a1,a2,a3,a4,a5, next] = div.children
    a1.click();
    // <div class="buttom__paginacion">
    //     <a href="#">&laquo;</a> 
    //     <a href="#" class="activo">1</a>
...
const getCoresId = async(e)=>{
    ...
    let Events = await getAllCoresId(e.target.id)
    //console.log(Events)

    await tableCoreColumn1(Events)
    await tableCoreColumn2(Events)

    await DetailsCoreInformation(Events)
    // await nameCapsules(Events)
